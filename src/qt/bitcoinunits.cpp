...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MBTC: return QString("MSILE");
    case kBTC: return QString("kSILE");
    case BTC: return QString("SILE");
    case mBTC: return QString("mSILE");
    case uBTC: return QChar(0x03BC) + QString("SILE");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-SIMPLEs (1,000,000)");
    case kBTC: return tr("Kilo-SIMPLEs (1,000)");
    case BTC: return tr("SIMPLEs");
    case mBTC: return tr("Milli-SIMPLEs (1 / 1,000)");
    case uBTC: return tr("Micro-SIMPLEs (1 / 1,000,000)");
    default: return QString("???");
    }
}
