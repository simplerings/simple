...
// Copyright (c) 2014-2019 The SIMPLE Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("SIMPLE Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // SIMPLE: load fallback font in case Comic Sans is not availble on the system
    ...
    // SIMPLE: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // SIMPLE: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SIMPLE address"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About SIMPLE Core"), this);
    aboutAction->setStatusTip(tr("Show information about SIMPLE Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for SIMPLE Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SIMPLE addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SIMPLE addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SIMPLE Core help message to get a list with possible SIMPLE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SIMPLE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SIMPLE network", "", count));
}
...
{
    QString strTitle = tr("SIMPLE"); // default title
