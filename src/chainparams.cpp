...
// Copyright (c) 2019 The SIMPLE Core developers
...
public:
    CMainParams() {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040184710fa689ad21103690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        ...
        vSeeds.push_back(CDNSSeedData("simple.com", "seed.simple.com"));
        vSeeds.push_back(CDNSSeedData("multisile.org", "seed.multisile.org"));
        vSeeds.push_back(CDNSSeedData("multisile.org", "seed2.multisile.org"));
        vSeeds.push_back(CDNSSeedData("siler.simple.com", "seed.siler.simple.com"));
        ...
        //TODO: fix this for simple -- plddr
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("042756726da3c7ef515d89212ee17021103d14be389e25fe15611585661b9a20021908b2b80a3c7200a0139dd2b26946606aab0eef9aa7689a6dc2c7eee237fa834");
        nDefaultPort = 44556;
        nMinerThreads = 0;
