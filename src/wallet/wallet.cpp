        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // SIMPLE: Disable free transactions
...
{
    // SIMPLE: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // SIMPLE: Add an increased fee for each dust output
        nFeeNeeded += GetSIMPLEDustFee(tx.vout, minTxFee);
    }
